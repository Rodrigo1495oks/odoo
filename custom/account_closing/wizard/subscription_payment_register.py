...
class suscriptionPaymentRegister(models.TransientModel):
    _name = 'suscription.payment.register'
    ...
    def _get_line_batch_key(self, line):
        ...
        return {
            ...
            'partner_type': 'shareholder' if move.move_type=='suscription' else 'customer' if line.account_type == 'asset_receivable' else 'supplier',
        }
