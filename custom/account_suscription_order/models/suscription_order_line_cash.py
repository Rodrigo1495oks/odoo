...
class suscriptionOrderLineProduct(models.Model):
    _name = 'account.suscription.order.line.cash'
...
class SuscriptionOrder(models.Model):
    ...
    cash_lines = fields.One2many(string='Products', comodel_name='account.suscription.order.line.cash', 
                                    inverse_name='order_id', 
                                    copy=False, 
                                    readonly=False,
                                    states={'draft': [('readonly', False)]}, 
                                    help='Cash lines or equivalents')