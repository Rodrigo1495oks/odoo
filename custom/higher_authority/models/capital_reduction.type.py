...
class CapitalReductionType(models.Model):
    ...
    profit_lost_account=fields.Many2one(string='Cuenta de resultados no Asignados', comodel_name='account.account')

    counterpart_account=fields.Many2one(string='Contrapartida', comodel_name='account.account')
