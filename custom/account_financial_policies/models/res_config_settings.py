...
class ResConfigSettings(models.TransientModel):
    ...
    property_account_contribution_id = fields.Many2one('account.account', company_dependent=True,readonly=False,
                                                       ...
                                                       domain="[('account_type', '=', 'contribution'),('deprecated', '=', False), ('company_id', '=', company_id)]",related='company_id.property_account_contribution_id',
    ...
    property_account_contribution_losses_id = fields.Many2one('account.account', company_dependent=True,readonly=False,
                                                       ...
                                                       related='company_id.property_account_contribution_losses_id',config_parameter='account_financial_policies.property_account_contribution_losses_id')
    property_account_issue_discount_id = fields.Many2one('account.account', company_dependent=True,readonly=False,
                                                         ...
                                                         related='company_id.property_account_issue_discount_id',config_parameter='account_financial_policies.property_account_issue_discount_id')
    property_account_issue_premium_id = fields.Many2one('account.account', company_dependent=True,readonly=False,
                                                        ...
                                                        related='company_id.property_account_issue_premium_id',config_parameter='account_financial_policies.property_account_issue_premium_id')
    property_account_portfolio_shares = fields.Many2one('account.account', company_dependent=True,readonly=False,
                                                        ...
                                                        related='company_id.property_account_portfolio_shares',config_parameter='account_financial_policies.property_account_portfolio_shares')
    account_capital_adjustment = fields.Many2one('account.account', company_dependent=True,readonly=False,
                                                 ...
                                                 related='company_id.account_capital_adjustment',config_parameter='account_financial_policies.account_capital_adjustment')

    account_shareholders_for_redemption_of_shares = fields.Many2one('account.account', company_dependent=True,readonly=False,
                                                                    ...
                                                                    help="Esta cuenta será usada para las para registrar las deuda con los accionistas, a quienes debe reintegrarseles el valor de mercado de las acciones vendidas (Deudas)",
                                                                     related='company_id.account_shareholders_for_redemption_of_shares',config_parameter='account_financial_policies.account_shareholders_for_redemption_of_shares')
    account_share_redemption_discount = fields.Many2one('account.account', company_dependent=True,readonly=False,
                                                        ...
                                                        related='company_id.account_share_redemption_discount',config_parameter='account_financial_policies.account_share_redemption_discount')
    ...
    percentage_redemption = fields.Float(string='Porcentaje de rescate', help='Porcentaje fijado por la Gerencia para el pago en efectivo por cancelación de acciones',
                                         config_parameter='account_financial_policies.percentage_redemption', related='company_id.percentage_redemption',default=0.0,readonly=False,)
    ...
    account_financial_expenses = fields.Many2one('account.account', company_dependent=True,
                                                 ...
                                                 related='company_id.account_financial_expenses',config_parameter='account_financial_policies.account_financial_expenses')
    ...
    account_cert_payable = fields.Many2one('account.account', company_dependent=True,
                                           ...
                                           related='company_id.account_cert_payable',config_parameter='account_financial_policies.account_cert_payable')
    ...
    account_cert_interest = fields.Many2one('account.account', company_dependent=True,readonly=False,
                                           ...
                                           related='company_id.account_cert_interest',config_parameter='account_financial_policies.account_cert_interest')
    ...
    account_receivable_cert=fields.Many2one('account.account', company_dependent=True,readonly=False,
                                           ...
                                           related='company_id.account_receivable_cert',config_parameter='account_financial_policies.account_receivable_cert')
    ...
    account_cert_amortized=fields.Many2one('account.account', company_dependent=True,readonly=False,
                                           ...
                                           related='company_id.account_cert_amortized',config_parameter='account_financial_policies.account_cert_amortized' )
    ...
    account_legal_reserve=fields.Many2one('account.account',company_dependent=True,readonly=False,
                                           ...
                                           related='company_id.account_legal_reserve',config_parameter='account_financial_policies.account_legal_reserve' )